...
<template>
	<div class="navbar">
		...
		<div v-if="authStore.currentPath !== 'admin'" class="navbar-tabs">
			<router-link
			...
			<router-link to="/ai-tour"> AI 導覽 </router-link>
		</div>
				...
				<ul>
					<li>
						<a
							:href="
								isLocalhost
									? 'https://citydashboard.taipei/documentation/'
									: `${location.origin}/documentation/`
							"
							target="_blank"
							rel="noreferrer"
							>技術文件</a
